...
import ToolArtifactCodeEditor from './ToolArtifactCodeEditor'
import ToolArtifactJsonSchemaEditor from './ToolArtifactJsonSchemaEditor'
            ...
            <Card className="p-4 rounded-2xl shadow-sm space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <ToolArtifactJsonSchemaEditor
                        control={control}
                        form={form}
                        name="inputSchema" // ✅ FIXED (was inputsSchema)
