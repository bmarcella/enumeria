...
export function AgentDefinitionCreatePageBase() {
    ...
    const onSubmit = async (payload: any) => {
        ...
        try {
            ...
            // redirect to edit page if you have it
            if (agent?.id) nav(`/developer/update/agent-manifest/${agent.id}`)
        } catch (e: any) {
            setServerError(
...
const AgentDefinitionCreatePage = () => {
    return <AgentDefinitionCreatePageBase></AgentDefinitionCreatePageBase>
}
