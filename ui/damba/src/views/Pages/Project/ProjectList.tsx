...
import { SocketAction, EntityType } from '../../../../../../common/Damba/core/Socket';
...
export const ProjectList = () => {
  ...
  const {
          ...
          defaultValues: {
              description: 'Create a todo list app that allow user to manage his tasks ',
          },
      });
  ...
  return (
    <div className="mt-8 grid grid-cols-1 gap-4 lg:grid-cols-12">
      ...
      <main className="lg:col-span-8">
       { !prompt && <Card className="p-4"  header={{
